...
export async function sendPasswordResetEmail({ email, name, resetToken, userRole }) {
  try {
    ...
    const landingUrl = process.env.LANDING_URL || 'https://aircrew.nl';
