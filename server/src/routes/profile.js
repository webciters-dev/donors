  ...
  async (req, res) => {
    ...
    try {
      ...
      const financials = {
        ...
        stationeryExpense: stationeryExpense != null ? Number(stationeryExpense) : null,
        booksExpense: booksExpense != null ? Number(booksExpense) : null,
        messExpense: messExpense != null ? Number(messExpense) : null,
        computerLaptop: computerLaptop != null ? Number(computerLaptop) : null,
        travelExpense: travelExpense != null ? Number(travelExpense) : null,
